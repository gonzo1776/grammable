...
RSpec.describe GramsController, type: :controller do
   ...
   describe "grams#destroy action" do
    ...
    describe "grams#edit action" do
      ...
      it "shouldn't let unauthenticated users update a gram" do
        gram = FactoryBot.create(:gram)
        patch :edit, params: { id: gram.id, gram: { message: "Hello" } }
        expect(response).to redirect_to new_user_session_path
      end


      it "should successfully show the form if the gram is found" do
        gram = FactoryBot.create(:gram)
        sign_in gram.user
      ...
      it "should return a 404 error message if the gram is now found" do
        user = FactoryBot.create(:user)
        sign_in user
